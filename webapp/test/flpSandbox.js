		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Usage Threshold Validation",
									"targetURL": "#comsaplhmrzusagethresholdbasic-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaplhmrzusagethresholdbasic-display": {
								"semanticObject": "comsaplhmrzusagethresholdbasic",
								"action": "display",
								"description": "Usage Threshold Validation",
								"title": "Usage Threshold Validation",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.lh.mr.zusagethresholdbasic",
									"url": sap.ui.require.toUrl("com/sap/lh/mr/zusagethresholdbasic")
								}
							}
						}
					}
